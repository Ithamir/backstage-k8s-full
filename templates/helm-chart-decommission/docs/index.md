...
The `helm-chart-decommission` Template opens a pull request that removes a scaffolded workload chart from this repository. It is intended for Components originally created by the `application` Template.
